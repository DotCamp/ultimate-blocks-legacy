...
function ub_render_number_box_block($attributes){
    ...
    return '<div class="ub_number_box column_'.$column.' '.esc_attr($className).'" id="ub-number-box-'.$blockID.'">'.$columns.'</div>';
}

function ub_register_number_box_block() {
	if ( function_exists( 'register_block_type' ) ) {
        register_block_type( 'ub/number-box-block', array(
            'attributes' => $GLOBALS['defaultValues']['ub/number-box-block']['attributes'],
