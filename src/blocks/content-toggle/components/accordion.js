	...
	render() {
		...
		return (
			<div
				...
				style={{ borderColor: attributes.theme }}
				key={i}
			>
				<div
					className="wp-block-ub-content-toggle-accordion-title-wrap"
					style={{ backgroundColor: attributes.theme }}
				>
					<RichText
						tagName="span"
						style={{
