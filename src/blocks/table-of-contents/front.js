...
document.addEventListener( 'DOMContentLoaded', function () {
	...
	instances.forEach( ( instance ) => {
		...
		if (
			JSON.parse( block.getAttribute( 'data-initiallyhideonmobile' ) )
		) {
		...
		instance.addEventListener( 'click', function ( event ) {
			...
			if (
				block.classList.contains( 'ub_table-of-contents-collapsed' )
			) {
				//begin showing
...
Array.prototype.slice
	.call(
		document.querySelectorAll( '.ub_table-of-contents-container li > a' )
	)
	.forEach( ( link ) => {
