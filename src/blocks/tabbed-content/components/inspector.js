			...
			<>
				<InspectorControls group="settings">
					<PanelBody title={__('Tab Type')}>
						<RadioControl
							selected={tabStyle}
							options={['tabs', 'pills', 'underline'].map(
								(a) => ({
									label: __(a),
									value: a,
								})
				...
				<InspectorControls group="styles">
					<SavedStylesInspector
						...
						setAttribute={(val) => {
							...
							const { tabsTitle, tabsTitleAlignment, ...rest } =
								val;
						...
						previewElementCallback={(el) => {
							const isVertical =
								el.querySelector('.vertical-holder');
